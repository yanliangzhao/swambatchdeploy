...
wget wget https://raw.githubusercontent.com/yanliangzhao/swambatchdeploy/main/step2.sh && chmod 777 step2.sh
wget wget https://raw.githubusercontent.com/yanliangzhao/swambatchdeploy/main/step3.sh && chmod 777 step3.sh
